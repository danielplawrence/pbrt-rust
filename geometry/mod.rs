...
impl<T:Real + Copy> Add for Vector2d<T> {
    type Output = Vector2d<T>;
    fn add(self, other: Self) -> Self::Output {
        Vector2d::new(self.x + other.x, self.y + other.y)
    }
}
impl<T:Real + Copy> Sub for Vector2d<T> {
    type Output = Vector2d<T>;
    fn sub(self, other: Self) -> Self::Output {
        Vector2d::new(self.x - other.x, self.y - other.y)
    }
}
impl<T:Real + Copy> Mul<T> for Vector2d<T> {
    type Output = Vector2d<T>;
    fn mul(self, other: T) -> Self::Output {
        Vector2d::new(self.x * other, self.x * other)
    }
}
impl<T:Real + Copy> Div<T> for Vector2d<T> {
    type Output = Vector2d<T>;
...
impl <T:Real + Copy> Add for Vector3d<T> {
    type Output = Vector3d<T>;
    fn add(self, other: Self) -> Self::Output {
        Vector3d::new(self.x + other.x, self.y + other.y, self.z + other.z)
    }
}
impl <T:Real + Copy> Sub for Vector3d<T> {
    type Output = Vector3d<T>;
    fn sub(self, other: Self) -> Self::Output {
        Vector3d::new(self.x - other.x, self.y - other.y, self.z - other.z)
    }
}
impl <T:Real + Copy> Mul<T> for Vector3d<T> {
    type Output = Vector3d<T>;
    fn mul(self, other: T) -> Self::Output {
        Vector3d::new(self.x * other, self.y * other, self.z * other)
    }
}
impl <T:Real + Copy> Div<T> for Vector3d<T> {
    type Output = Vector3d<T>;
    fn div(self, other: T) -> Self::Output {
        Vector3d::new(self.x / other, self.y / other, self.z / other)
    }
